...
// Generated by: generate_spark_overrides.py <spark-3.5.9-bin-hadoop3-scala2.13> 3.5.9 2.13
...
object SparkDependencies {
  lazy val dependencies = Seq(
    ...
    "org.apache.avro" % "avro-ipc" % "1.11.5",
    "org.apache.avro" % "avro-mapred" % "1.11.5",
    ...
    "org.apache.orc" % "orc-mapreduce" % "1.9.8",
    ...
    "org.glassfish.jersey.containers" % "jersey-container-servlet" % "2.47",
    "org.glassfish.jersey.containers" % "jersey-container-servlet-core" % "2.47",
